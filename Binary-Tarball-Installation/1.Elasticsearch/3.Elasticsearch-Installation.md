...
Environment=ES_HOME=/es/elasticsearch-9.2.3
Environment=ES_PATH_CONF=/es/elasticsearch-9.2.3/config
Environment=PID_DIR=/es/elasticsearch-9.2.3
Environment=ES_SD_NOTIFY=true

RuntimeDirectory=elasticsearch
RuntimeDirectoryMode=2755

WorkingDirectory=/es/elasticsearch-9.2.3
...
ExecStart=/es/elasticsearch-9.2.3/bin/elasticsearch
