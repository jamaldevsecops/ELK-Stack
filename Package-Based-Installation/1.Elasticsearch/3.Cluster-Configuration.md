...
## 🔑 Common Cluster Settings (ALL Nodes)
...
## 🔎 Discovery Configuration (ALL Nodes)
...
## 🚀 Initial Cluster Bootstrap (FIRST START ONLY)
...
🔁 How to reset the elastic password (safe method)
...
```
You’ll be prompted:  
Generate automatically? → Y (recommended), or  
Enter your own strong password  
📌 This updates the password cluster-wide.  
