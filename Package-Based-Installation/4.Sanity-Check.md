# 🧪 Elasticsearch Cluster Sanity Check Guide
...
## 🧩 2. Verify Node Membership & Roles
...
✔ Confirms correct **role separation**

---

## 1️⃣ Remove -k (recommended)
...
✔ Confirms CA is trusted system-wide
...
```bash
curl -u elastic https://es1:9200/_security/_authenticate?pretty
```
...
✔ All nodes visible  
✔ Single master elected

---

## 📊 6. Resource & JVM Check
...
🎉 **Your Elasticsearch cluster is production-ready**
